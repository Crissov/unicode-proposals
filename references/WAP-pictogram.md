| Emoji | Class[/Subclass]/Name | Description |
|-------|-----------------------|-------------|
...
| 📎 | `core/message/attachment` | a symbol for an attachment/paper clip |
...
| ♋️ | `horoscope/cancer` | Cancer / the Crab |
...
| ⚽️ | `sport/soccer` | a symbol of soccer, football |
